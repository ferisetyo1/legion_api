...
class CreateRefundPrivatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('legion_refund_privates', function (Blueprint $table) {
            $table->id('refund_id');
    ...
    {
        Schema::dropIfExists('legion_refund_privates');
    }
}
